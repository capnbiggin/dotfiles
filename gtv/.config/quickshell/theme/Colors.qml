...
Singleton {
  ...
  readonly property color bg4: Pallet.surface1

  readonly property color bgBlack: "#000000"

  // ─── Foreground ───────────────────────
  readonly property color fg: Pallet.text
  readonly property color fgMuted: Pallet.subtext0
  // readonly property color fgMuted: alpha(fg, 0.60)
  readonly property color accent: Pallet.lavender

  // ─── Colors ───────────────────────────
  readonly property color red: Pallet.red
  readonly property color green: Pallet.green
  readonly property color orange: Pallet.peach
  readonly property color yellow: Pallet.yellow
  readonly property color blue: Pallet.blue
  readonly property color purple: Pallet.lavender
  readonly property color teal: Pallet.teal

  // ─── Greys ───────────────────────────
  readonly property color grey0: Pallet.overlay0
  readonly property color grey1: Pallet.overlay1
  readonly property color grey2: Pallet.overlay2
