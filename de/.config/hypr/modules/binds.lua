...
-- Monocle Layout Binds
hl.bind(mod .. " + ALT + up", hl.dsp.layout("cyclenext"))
hl.bind(mod .. " + ALT + down", hl.dsp.layout("cycleprev"))
hl.bind(mod .. " + ALT + K", hl.dsp.layout("cyclenext"))
hl.bind(mod .. " + ALT + J", hl.dsp.layout("cycleprev"))
-- END Monocle Layout Binds
